...
\documentclass[preprint2, en]{aastex7}

\input{Config/Locales/internationalization.tex}
...
\input{Pages/Sections/1_objetivos}
\input{Pages/Sections/2_intro_y_marco_teorico}
\input{Pages/Sections/3_montaje_experimental}
\input{Pages/Sections/4_resultados_y_analisis}
\input{Pages/Sections/5_discuciones}
\input{Pages/Sections/6_conclusiones}
